        ...
        <div className="fx-topbar-inner flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2" data-testid="brand-logo">
            ...
            <div className="leading-tight">
              <div className="font-display text-xl text-fx">{settings?.appName || "FixitZ"}</div>
              <div className="text-[10px] font-bold -mt-0.5 flex items-center gap-1 text-n700"><MapPin className="w-3 h-3 text-fx" />{settings?.city || "Jammu"} · {settings?.tagline || "30-Min Doorstep Repair"}</div>
            </div>
          </Link>
